...
typedef struct impulse_aux impulse_aux_t;
...
/**
 * Adds a force creator to a scene that destroys two
 * bodies when they collide. The bodies should be
 * destroyed by calling body_remove().
 *
 * @param scene the scene containing the bodies
 * @param body1 the first body
 * @param body2 the second body
